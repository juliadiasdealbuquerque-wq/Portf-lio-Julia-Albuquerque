...
const courses = [
  ...
  { title: 'Planejamento Harvard', area: 'Estratégia', year: '2023' },
  { title: 'Rapport e Influência', area: 'Relacionamento', year: '2023' },
          ...
          <div className="relative">
            ...
            <div className="space-y-4">
              {courses.map((course, i) => (
                ...
                >
                  {/* Node */}
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 -translate-x-1/2 w-5 h-5 rounded-full bg-white border-2 border-violet-500 flex items-center justify-center">
                    <CheckCircle2 size={10} className="text-violet-500" />
                  </div>

                  <div className="flex-1 flex flex-col sm:flex-row sm:items-center justify-between gap-2 p-4 rounded-xl bg-zinc-50 border border-zinc-200/80 hover:border-violet-200 hover:bg-violet-50/30 transition-all duration-200 group">
